...
Consume el backend FastAPI del Homebanking publicado en Render usando `VITE_API_URL`.
...
- El backend FastAPI del Homebanking publicado en Render
...
```
VITE_API_URL=https://alfin-homebanking-backend.onrender.com
```
