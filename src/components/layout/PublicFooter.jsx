    ...
    <footer className="lp-footer" id="footer">
      <div className="lp-footer-inner">
        <div className="lp-footer-brand">
          ...
          <p>Tu banco digital con experiencia simple y cercana. Operaciones 100% en línea, seguras y a tu alcance.</p>
        ...
        <div className="lp-footer-col">
          ...
          <ul className="lp-contact">
            ...
            <li><Mail size={15} /> contacto@alfindigital.pe</li>
      ...
      <div className="lp-footer-legal">
        © {2026} Alfin Digital — Banca por Internet.
      </div>
    </footer>
  )
}
