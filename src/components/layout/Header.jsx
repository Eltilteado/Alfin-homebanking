...
// Pestañas principales (patrón de banca digital): Inicio · Cuentas · Préstamos · Operaciones.
const TABS = [
      ...
      <div className="bbva-topbar">
        <div className="bbva-topbar-inner">
          <button className="bbva-brand" onClick={() => navigate('/inicio')} aria-label="Inicio">
            <Logo size={36} variant="light" subtitle="BANCA EN LÍNEA" />
          </button>
